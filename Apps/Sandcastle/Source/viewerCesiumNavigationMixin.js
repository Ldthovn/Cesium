  ...
  function() {
          ...
          (function() {
            ...
            d.prototype = {
              save: function(b, c) {
                ...
                0 <= d
                  ? (this.Ib[d] = c)
                  : (this.keys.push(b), this.Ib.push(c));
              },
              get: function(b) {
                b = a.a.o(this.keys, b);
            ...
            function b(b, d, e, f, g) {
              ...
              for (q = p; h || q; )
                (p = m[h][q] - 1),
                  q && p === m[h][q - 1]
                    ? l.push(
                        (k[k.length] = { status: e, value: d[--q], index: q })
                      )
                    : h && p === m[h - 1][q]
                    ? s.push(
                        (k[k.length] = { status: f, value: b[--h], index: h })
                      )
                    : (--q,
                      --h,
      ...
      (o.version = "0.7.7"),
        ...
        (function() {
          ...
          (o.Util.requestAnimFrame = function(e, n, a, r) {
            return (
              (e = o.bind(e, n)), a && s === i ? void e() : s.call(t, e, r)
            );
          }),
        ...
        o.extend(o.GeoJSON, {
          geometryToLayer: function(t, e, i, n) {
            ...
            switch (((i = i || this.coordsToLatLng), l.type)) {
              ...
              case "LineString":
                return (
                  (a = this.coordsToLatLngs(u, 0, i)), new o.Polyline(a, n)
                );
              case "Polygon":
                  ...
                  r || (this._animatingZoom = !0),
                    ...
                    o.Util.requestAnimFrame(function() {
                      this.fire("zoomanim", {
                        ...
                        setTimeout(
                          o.bind(this._onZoomTransitionEnd, this),
                          250
                        );
                    }, this);
                },
    ...
    define("ViewModels/NavigationViewModel", [
      ...
      function orbit(viewModel, compassElement, cursorVector) {
        ...
        viewModel.orbitMouseMoveFunction = function(e) {
          ...
          var vector = Cartesian2.subtract(
            clickLocation,
            center,
            vectorScratch
          );
    ...
    define("viewerCesiumNavigationMixin", [
      ...
      var init = function(viewerCesiumWidget, options) {
        var cesiumNavigation = new CesiumNavigation(
          viewerCesiumWidget,
          options
        );
        var cesiumWidget = defined(viewerCesiumWidget.cesiumWidget)
