...
import { SvgPathBindingHandler, getElement, defined, Ray, Cartesian3, Cartographic, SceneMode, DeveloperError, EllipsoidGeodesic, Cartesian2, getTimestamp, EventHelper, defineProperties, Camera, Rectangle, IntersectionTests, Math as Math$1, Transforms, Matrix4, BoundingSphere, HeadingPitchRange, Event } from 'cesium';
...
function loadView(htmlString, _container, viewModel) {
  var container = getElement(_container);
...
{var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},_ref$units = _ref.units,units = _ref$units === undefined ? 'kilometers' : _ref$units,_ref$distanceLabelFor = _ref.distanceLabelFormatter,distanceLabelFormatter$$1 = _ref$distanceLabelFor === undefined ? distanceLabelFormatter : _ref$distanceLabelFor;
  ...
  new Cartesian2(1 + width / 2 | 0, height - 1));var
...
function orbit(_viewModel, compassElement, cursorVector) {
  ...
  viewModel.orbitLastTimestamp = getTimestamp();var
  ...
  viewModel.orbitTickFunction = function (e) {
    ...
    var angle = viewModel.orbitCursorAngle + Math$1.PI_OVER_TWO;
  ...
  function updateAngleAndOpacity(vector, compassWidth) {
    ...
    viewModel.orbitCursorAngle = Math$1.zeroToTwoPi(
    angle - Math$1.PI_OVER_TWO);
...
function rotate(_viewModel, compassElement, cursorVector) {
  ...
  viewModel.rotateMouseMoveFunction = function (e) {
    ...
    var newCameraAngle = Math$1.zeroToTwoPi(
